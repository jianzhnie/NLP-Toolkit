'''
Author: jianzhnie
Date: 2022-03-09 17:36:02
LastEditTime: 2022-03-10 14:14:40
...
class BertEmbeddings(nn.Module):
    ...
    def forward(self,
        ...
        # step2: segment embeddings
        token_type_embeddings = self.token_type_embeddings(token_type_ids)

        embeddings = inputs_embeds + token_type_embeddings

        # step3: position embeddings
    ...
    def forward(
        ...
        if self.is_decoder and encoder_hidden_states is not None:
            if not hasattr(self, 'crossattention'):
                raise ValueError(
                    f'{self} has to be instantiated with cross-attention layers by setting'
                )
